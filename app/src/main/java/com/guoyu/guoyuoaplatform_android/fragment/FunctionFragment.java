...
import com.guoyu.guoyuoaplatform_android.customview.BaseGridView;
import com.guoyu.guoyuoaplatform_android.adapter.FunctionAdapter;
...
public class FunctionFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        gridView = (BaseGridView) this.getActivity().findViewById(R.id.gridView);

        FunctionAdapter adapter = new FunctionAdapter(this.getActivity());
